...
```groovy
dependencies {
    implementation 'com.github.gegeName:picker:0.1.0'
}
```
...
本项目（以下简称"本软件"）仅供学习、研究和合法用途使用。

1. 本软件按"现状"（AS IS）提供，作者不对其适用性、可靠性、安全性作任何明示或暗示的担保。
2. 使用者应自行遵守所在国家/地区的法律法规。任何因使用本软件从事违法、侵权或其他不当活动所产生的后果，由使用者自行承担，与作者无关。
3. 作者不参与、不知晓、也不认可任何对本软件的非法使用。本软件为通用媒体选择工具，不针对任何违法用途设计。
4. 禁止将本软件用于任何违反法律法规的用途。一经发现，作者有权终止对相关使用者的任何支持。
5. 下载、克隆、引用或使用本软件，即表示你已阅读并同意以上条款。
